...
import { FaEnvelope, FaFilePdf, FaGithub, FaLinkedin, FaBluesky} from "react-icons/fa6";
              ...
              <div className="space-y-4"> 
                <div className="flex flex-col space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="./assets/jerome_ghesquiere.pdf" download="jerome_ghesquiere.pdf" className="hover:text-gray-600">
                      Mon CV (PDF)
                    </a>
                  </div>
                </div>
