...
const projects = [
  ...
  {
    title: 'Weber Saint Gobain - Mobile',
    client: 'Weber Saint Gobain',
    description:
      'Découvrez la nouvelle application mobile Saint-Gobain Weber… Vos services en un clic ! Consultez nos produits et leurs caractéristiques, scannez nos emballages ou notre Guide WEBER et obtenez les contenus associés en réalité augmentée, calculez les quantités de produits nécessaires à vos travaux',
    image:
      'https://www.ma.weber/files/ma/styles/1920x1080/public/pictures/2020-12/app%20weber.jpg.webp?itok=p3US3xy5',
    tech: ['Xamarin', 'iOS', 'Android'],
    live: 'https://www.youtube.com/watch?v=hRorYmARhD8',
    align: 'object-[0px,0px]',
  },
  {
