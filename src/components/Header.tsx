      ...
      <nav className='container mx-auto px-6 py-4'>
        <div className='flex justify-between items-center'>
          ...
          <div className='hidden md:flex gap-4'>
            ...
            >
              <FaFilePdf className='w-5 h-5 hover:text-gray-600 transition-colors' />
            </a>
            <a
            ...
            <a
              ...
              rel='noopener noreferrer'
            >
              <FaBluesky className='w-5 h-5 hover:text-gray-600 transition-colors' />
            </a>
          </div>
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className='flex gap-4 mt-4'>
              <a
                href='mailto:contact@jeromegsq.com'
                onClick={() => setIsMenuOpen(false)}
              >
                <FaEnvelope className='w-5 h-5 hover:text-gray-600 transition-colors' />
              </a>
