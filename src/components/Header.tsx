        ...
        <div className="flex justify-between items-center">
          ...
          >
            <a href="/" className="flex items-center gap-2">
              <img src="/assets/jeromegsq_avatar_transparent.png" alt="Logo" className="h-11" />
          ...
          >
            <div className="space-y-2">
              <span className={`block w-8 h-0.5 bg-gray-600 transition-transform ${isMenuOpen ? 'rotate-45 translate-y-2.5' : ''}`}></span>
              <span className={`block w-8 h-0.5 bg-gray-600 ${isMenuOpen ? 'opacity-0' : ''}`}></span>
              <span className={`block w-8 h-0.5 bg-gray-600 transition-transform ${isMenuOpen ? '-rotate-45 -translate-y-2.5' : ''}`}></span>
            </div>
          </button>
        </div>
